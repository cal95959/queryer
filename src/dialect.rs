...
pub struct CalDialect;

// 创建自己的sql方言，CalDialect支持identifier可以是简单的url
impl Dialect for CalDialect {
...
mod tests {
    ...
    #[test]
    fn it_works() {
        assert!(Parser::parse_sql(&CalDialect::default(), &example_sql()).is_ok())
    }
}
